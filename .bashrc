...
alias ll='ls -l'    # ファイルの詳細も同時に表示する
alias la='ls -A'    # ドット・ファイルを含んだすべてのファイルを表示する
alias ls='ls -xCF --color=auto'
alias sl='ls -xCF --color=auto'

alias grep='grep --color'     # 検索文字を色付きで表現

alias df='df -h'  # 容量を適当な単位で表示する
alias du='du -h'  #           〃

alias open='cygstart'   # pdfファイルなどを開く
